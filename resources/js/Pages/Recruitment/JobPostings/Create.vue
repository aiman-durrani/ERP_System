...
import Editor from 'primevue/textarea'; // Using Textarea for simplicity, but Editor is better for descriptions
    ...
    <AuthenticatedLayout>
        <div class="max-w-4xl mx-auto">
             <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Create Job Posting</h2>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-full flex justify-end gap-3 mt-4">
                        ...
                        <Button type="submit" label="Create Posting" :loading="form.processing" />
                    </div>
                </form>
            </div>
        </div>
