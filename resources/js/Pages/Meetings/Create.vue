...
<template>
    ...
    <Head title="Aimanova - Schedule Meeting" />

    <AuthenticatedLayout>
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Schedule Meeting</h2>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-4">
                ...
                <div class="flex justify-end gap-2 mt-4">
                    ...
                    <Button type="submit" label="Schedule Meeting" :loading="form.processing" />
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
